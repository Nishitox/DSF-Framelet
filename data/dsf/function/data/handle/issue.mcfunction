# /function dsf:data/handle/issue with storage dsf:handle
...
$execute if data storage dsf:handle used."$(cursor)" run return run function dsf:data/handle/issue with storage dsf:handle
